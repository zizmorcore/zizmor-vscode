...
> [!IMPORTANT]
> You **must** have `zizmor` v1.15.0 or later installed; earlier versions
> do not include full LSP support for all file types.
>
> If `zizmor --version` shows a version below 1.15.0, you **must** update
